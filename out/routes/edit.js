            ...
            if (exists && !(item != null)) {
              ...
              (function(__iced_k) {
                ...
                for (_k = 0, _len2 = _ref3.length; _k < _len2; _k++) {
                  char = _ref3[_k];
                  if (!(_ref4 = char + '' + char + '' + char, __indexOf.call(yamlString, _ref4) >= 0)) {
                    break;
                  }
                }
                doc = "" + (char + '' + char + '' + char) + "\n" + yamlString + "\n" + (char + '' + char + '' + char) + "\n" + content;
